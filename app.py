...
import database  # the postgres version
...
def login():
    ...
    return render_template("index.html", events=[], username=None, show_login=True, error="Invalid credentials")
...
def register():
    ...
    try:
        ...
        return render_template("index.html", events=[], username=None, show_login=True, error="Username already exists")
...
def add_sub():
    ...
    num_participants = request.form.get('num_participants') or 0
